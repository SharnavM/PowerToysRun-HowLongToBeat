...
public sealed class TitleNormalizerTests
{
    ...
    public void RemovesPunctuation()
    {
        Assert.AreEqual(
            ...
            TitleNormalizer.Normalize("Resident Evil 4: Separate Ways")
        );
    }
    ...
    {
        Assert.AreNotEqual(
            TitleNormalizer.Normalize("Modern Warfare 2"),
            TitleNormalizer.Normalize("Modern Warfare 3")
        );
    }
    ...
    {
        Assert.AreEqual("pokemon", TitleNormalizer.Normalize("Pokémon"));
    }

    [TestMethod]
    public void CollapsesWhitespace()
    {
        Assert.AreEqual("elden ring", TitleNormalizer.Normalize(" Elden   Ring "));
    }
}
