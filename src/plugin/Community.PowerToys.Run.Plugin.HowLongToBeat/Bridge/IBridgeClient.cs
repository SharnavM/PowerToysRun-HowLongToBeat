...
{
    Task<BridgePingResult> PingAsync(CancellationToken cancellationToken = default);
    ...
    Task<BridgeGame?> GetByIdAsync(int gameId, CancellationToken cancellationToken = default);
